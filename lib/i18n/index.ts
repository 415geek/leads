...
const zh = {
  ...
  owner_title: '老板信息搜索',
  owner_description:
    '先按姓名在 Whitepages 检索候选人；填写「匹配关键字」后，将结合全网搜索与 Claude 大模型交叉验证，并对每条结果给出匹配度评分。',
  owner_label_name: '姓名',
  owner_label_region: '地区',
  owner_label_address: '地址',
  owner_label_keywords: '匹配关键字',
  owner_placeholder_name: '例如：Tony Lu（必填）',
  owner_placeholder_region: '例如：San Francisco, CA / California',
  owner_placeholder_address: '例如：123 Market St 或 123 Market St, San Francisco, CA 94102',
  owner_placeholder_keywords: '例如：Lu’s Kitchen / 合伙人姓名（可选，用于交叉验证）',
...
const en: typeof zh = {
  ...
  owner_description:
    'Search by name on Whitepages first; optional match keywords trigger web search + Claude cross-validation with a match score per candidate.',
  owner_label_name: 'Name',
  owner_label_region: 'Region',
  owner_label_address: 'Address',
  owner_label_keywords: 'Match keywords',
  owner_placeholder_name: 'e.g. Tony Lu (required)',
  owner_placeholder_region: 'e.g. San Francisco, CA / California',
  owner_placeholder_address: 'e.g. 123 Market St or 123 Market St, San Francisco, CA 94102',
  owner_placeholder_keywords: 'e.g. Lu’s Kitchen / partner name (optional)',
