...
const zh = {
  ...
  owner_placeholder_keywords: '例如：Lu’s Kitchen / 123 Market St / 合伙人姓名（可选，用于交叉验证）',
...
const en: typeof zh = {
  ...
  owner_placeholder_keywords: 'e.g. Lu’s Kitchen / 123 Market St / partner name (optional)',
